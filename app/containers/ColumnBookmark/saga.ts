...
export function* addColumn({ id }: { id: 'public' }) {
...
export function* fetchBookmark({ id }: { id: 'public' }) {
...
export function* fetchNew({ restrict: id }: { restrict: Action['id'] }) {
  try {
