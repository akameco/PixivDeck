...
export type NEXT_ILLUST_PAGE_SUCCESS_TYPE = 'UserDrawer/NEXT_ILLUST_PAGE_SUCCESS'
export type NEXT_ILLUST_PAGE_FAILURE_TYPE = 'UserDrawer/NEXT_ILLUST_PAGE_FAILURE'
...
export type Action =
  ...
  | {
      type: ADD_DRAWER_USER_TYPE
      user: User
    }
  | {
      type: ADD_DRAWER_PROFILE_TYPE
      profile: Profile
    }
  | {
