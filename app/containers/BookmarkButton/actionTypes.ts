...
export type DELETE_BOOKMARK_SUCCESS_TYPE = 'BookmarkButton/DELETE_BOOKMARK_SUCCESS'
export type DELETE_BOOKMARK_FAILER_TYPE = 'BookmarkButton/DELETE_BOOKMARK_FAILER'
export type Action =
  | {
