...
export interface Props {
  onDelete: (tag: string) => undefined
  onSubmit: (tag: string) => undefined
  onCheckShowText: (isShow: boolean) => undefined
  onCheckIllustOnly: (isShow: boolean) => undefined
  onSelectLanguage: (locale: string) => undefined
